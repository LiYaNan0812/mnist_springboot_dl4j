...
import cn.lyn.mnist.MnistLiyananDl4jApplication;
...
public class CNN_MNIST {
    ...
    public static String tranModel() throws IOException {
        ...
        int seed = 123; //
//		final String DATA_PATH = FilenameUtils.concat(System.getProperty("java.io.tmpdir"), "mnist/");
//		File trainData = new File(DATA_PATH + "/mnist_png/training");
//		File testData = new File(DATA_PATH + "/mnist_png/testing");
        File trainData = new File("mnist/mnist_png/training");
        File testData = new File("mnist/mnist_png/testing");
